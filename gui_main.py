# FOLLOW https://github.com/TomSchimansky/CustomTkinter/blob/master/examples/complex_example.py
...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # configure window
        self.title("Nations and Notions")
        self.geometry(f"{1800}x{1200}")
